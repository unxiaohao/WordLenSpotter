...
def add_SWINTS_config(cfg):
    ...
    cfg.MODEL.SWINTS.NUM_PROPOSALS = 1000
    # cfg.MODEL.SWINTS.TEST_NUM_PROPOSALS = 602
    cfg.MODEL.SWINTS.TEST_NUM_PROPOSALS = 300
    ...
    cfg.MODEL.SWINTS.NUM_PRIOR = 1  ##
    cfg.MODEL.SWINTS.NUM_RATIO = 1  ##
    cfg.MODEL.SWINTS.NUM_CHARNUM = 1  ##
    cfg.MODEL.SWINTS.NUM_POLYGON = 3  ##
    cfg.MODEL.SWINTS.NUM_HEADS = 6

    cfg.MODEL.SWINTS.MASK_DIM = 60
    cfg.MODEL.SWINTS.POLYGON_DIM = 40  ##
    ...
    cfg.MODEL.SWINTS.PRIOR_WEIGHT = 1.0
    cfg.MODEL.SWINTS.RATIO_WEIGHT = 1.0
    cfg.MODEL.SWINTS.CHARNUM_WEIGHT = 1.0
    cfg.MODEL.SWINTS.POLYGON_WEIGHT = 2.0

    # Focal Loss.
    cfg.MODEL.SWINTS.ALPHA = 0.25
    cfg.MODEL.SWINTS.GAMMA = 2.0
    cfg.MODEL.SWINTS.PRIOR_PROB = 0.01
    cfg.MODEL.SWINTS.BETA = 0.7

    ## Dynamic K
    cfg.MODEL.SWINTS.OTA_K = 5

    ## Diffusion
    cfg.MODEL.SWINTS.SNR_SCALE = 2.0
    cfg.MODEL.SWINTS.SAMPLE_STEP = 2  # default = 1

    ## Inference
    cfg.MODEL.SWINTS.USE_NMS = True
