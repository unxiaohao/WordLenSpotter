...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image, confidence_threshold, path):
        ...
        image = image[:, :, ::-1]
        visualizer = Visualizer(image, self.metadata, instance_mode=self.instance_mode)  # English
        # visualizer = Visualizer_chn(image, self.metadata, instance_mode=self.instance_mode)  # Chinese
        # visualizer = Visualizer_vintext(image, self.metadata, instance_mode=self.instance_mode)  # Vietnamese 
